...
public interface teacherRepository  extends JpaRepository <Teacher,    Integer >,PagingAndSortingRepository<Teacher,    Integer >{
    ...
    **/
    ...
    /**
    * Metodo para obtener y filtrar el query de la entidad
    * @return Lista de tipo entidad
    * @author 00094119@uca.edu.sv
    * @version 1.0
    **/
